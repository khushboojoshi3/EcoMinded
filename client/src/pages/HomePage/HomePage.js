...
return(
    ...
    <div id={styles.bg}>
       ...
       <p>Sustainable living choices benefit the environment and well-being. Reduce waste, conserve, support eco-friendly practices. A better future.</p>
    </div>
        ...
        <div className={styles.polaroid}>
         <div className={styles.gifi}>
          ...
          <div className={styles.fact}>
            <h1>Did you know?</h1>
            <p>Plastic pollution is a major problem for our oceans and wildlife. It is estimated that there are over 5 trillion pieces of plastic in the world's oceans, and that number is growing every day.
        </p>
          ...
          <div className={styles.content}>
            ...
            <div className={styles.content_det1}>
              <h1>Energy Consumption</h1><p>Excessive consumption leads to increased use of
              fossil fuels for energy generation which is the major contributor to
              greenhouse gas emissions.</p><br/>
              </div>
              <div className={styles.content_det2}>
              <h1>Consumerism</h1><p>Our culture of constant consumption and disposability
              is fueling resource depletion and waste production.</p><br/>
              </div>
              <div className={styles.content_det3}>
              <h1>Waste Management</h1><p>Poor waste management ranges from improper
                disposal, insufficient recycling, and excessive consumption</p>
                </div>
                </div>
          </div>
