...
function Profile() {
  ...
  const customstyless = {
    content: {
      ...
      marginRight: "-50%",
      background:
        "radial-gradient(1200px at 50% 40%, rgb(191, 224, 251) 0%, rgb(232, 233, 251) 25.8%, rgb(252, 239, 250) 50.8%, rgb(234, 251, 251) 77.6%, rgb(240, 251, 244) 100.7%)",
  ...
  useEffect(() => {
    ...
    update();
  }, [id, refetch, refetchArt, refetchBlog, refetchReward]);
              ...
              <PivotItem headerText="Art">
                {errArt ? (
                  ...
                  <Label styles={labelStyles}>
                    <Art
                      updateArts={fetchUpdatedArts}
                      arts={arts?.data}
                      isVisible={user._id === id}
                    />
                  </Label>
                )}
              </PivotItem>
